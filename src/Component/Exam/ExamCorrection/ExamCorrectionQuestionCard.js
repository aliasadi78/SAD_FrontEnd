...
export default function ExamCorrectionQuestionCard(props){    
            ...
            <Container maxWidth="md" alignItems="center" component="main" style={{fontFamily: 'Vazir',marginTop: '1%' , paddingBottom : '10px',paddingTop: '1%',backgroundColor : 'white',fontSize: '16px',direction: 'rtl',textAlign: 'right'}}>
              ...
              <p style={{color : '#1ca0a0'}}>
                ...
                <Grid item xs={12} >
                    ...
                    <Paper component="form" className={classes.root} style={{backgroundColor :                        
                        props.q.answerGrade < (props.q.grade / 3)  ?
                        '#E63946' :
                        props.q.answerGrade > (props.q.grade / 3)*2 ?
                        '#2A9D8F' :
                        '#E9C46A'                        
                        }}
                    >
                        <form className={classes.form} style={{textAlign : 'center'}} noValidate autoComplete="off">                    
                            <CssTextField margin= 'dense'                                 
                            // onChange = {sendGrades}
                            onChange = { (e) =>  props.OnChange( e.target.value) }
                            defaultValue = {props.q.answerGrade}                            
                            id="outlined-basic" label={<span style = {{fontFamily: 'Vazir' , color : 'white'}}>
                                نمره
                            </span>} variant="outlined" />                             
                        </form>
                        <Divider color = 'white' className={classes.divider} orientation="vertical" />
                        <p style = {{fontFamily: 'Vazir' , color:'white'}} > از {props.q.grade} نمره </p>
                    </Paper>
