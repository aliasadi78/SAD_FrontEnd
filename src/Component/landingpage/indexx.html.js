            ...
            <section className="hero text-light text-center">
                <div className="container-sm">
                    <div className="hero-inner">
                        <h1 className="hero-title h2-mobile mt-0 is-revealing">Landing template for startups</h1>
                        <p className="hero-paragraph is-revealing">Our landing page template works for all the devices, so you only have to setup it once, and get beautiful results forever.</p>
                        <p className="hero-cta is-revealing"><a className="button button-secondary button-shadow" href="#">Get started now</a></p>
