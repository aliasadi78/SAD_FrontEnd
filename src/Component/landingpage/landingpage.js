            ...
            <div style={{marginTop:'-2%'}}>
                ...
                <footer style={{borderTop: 'solid 1px'}}>
                        ...
                        <div  style={{position: 'relative',left: '3%',marginTop: '-2%'}}>
                            <span style={{display: 'inline-block'}}><a href="http://www.instagram.com/online_exam_parham" target="_blank">
                            ...
                            <span><Button onClick={handleClick}><img className={classes.image} src={require("./image/android.png")} width='30px' height='30px' style={{borderRadius: '50px',color: 'white',marginRight: '72%'}}></img></Button></span>
                        </div>
