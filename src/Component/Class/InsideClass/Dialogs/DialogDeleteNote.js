    ...
    return(
        <div>
            ...
            <Dialog style={{fontFamily: 'Vazir'}} open={openDelete} onClose={handleClose} aria-labelledby="form-dialog-title">
                ...
                <span style={{fontFamily: 'Vazir' ,}}>حذف اعلان ؛ آیا مطمئنید ؟ </span>
                </DialogTitle>
                ...
                <DialogContent>
                <Button onClick={handleClose} color="primary" style={{backgroundColor: '#98C1D9',color: 'white' ,margin: '0% 0% 0% 2%',fontFamily: 'Vazir',width: '49%'}}>
                          خیر
                        </Button>
