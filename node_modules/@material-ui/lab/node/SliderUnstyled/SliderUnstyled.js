...
var _ValueLabelUnstyled = _interopRequireDefault(require("./ValueLabelUnstyled"));
...
function focusThumb({
  ...
  const doc = (0, _utils2.ownerDocument)(sliderRef.current);
...
const useSliderClasses = props => {
  ...
  const utilityClasses = {
    root: (0, _clsx.default)(getUtilityClass('root'), getUtilityClass(`color${(0, _utils2.capitalize)(color)}`), disabled && 'Mui-disabled', marked && getUtilityClass('marked'), track === false && getUtilityClass('trackFalse'), orientation === 'vertical' && getUtilityClass('vertical'), track === 'inverted' && getUtilityClass('trackInverted')),
    ...
    thumb: (0, _clsx.default)(getUtilityClass('thumb'), getUtilityClass(`thumbColor${(0, _utils2.capitalize)(color)}`), disabled && 'Mui-disabled')
  };
...
const SliderUnstyled = /*#__PURE__*/React.forwardRef(function SliderUnstyled(props, ref) {
  ...
  const handleFocusRef = (0, _utils2.useForkRef)(focusVisibleRef, sliderRef);
  const handleRef = (0, _utils2.useForkRef)(ref, handleFocusRef);
  const handleFocus = (0, _utils2.useEventCallback)(event => {
  ...
  const handleBlur = (0, _utils2.useEventCallback)(event => {
  ...
  const handleMouseOver = (0, _utils2.useEventCallback)(event => {
    const index = Number(event.currentTarget.getAttribute('data-index'));
    setOpen(index);
  });
  const handleMouseLeave = (0, _utils2.useEventCallback)(() => {
    setOpen(-1);
  });
  (0, _utils2.unstable_useEnhancedEffect)(() => {
  ...
  const handleKeyDown = (0, _utils2.useEventCallback)(event => {
    const index = Number(event.currentTarget.getAttribute('data-index'));
  ...
  const handleTouchMove = (0, _utils2.useEventCallback)(nativeEvent => {
  ...
  const handleTouchEnd = (0, _utils2.useEventCallback)(nativeEvent => {
    const finger = trackFinger(nativeEvent, touchId);
  ...
  const handleTouchStart = (0, _utils2.useEventCallback)(event => {
  ...
  const handleMouseDown = (0, _utils2.useEventCallback)(event => {
    if (onMouseDown) {
      onMouseDown(event);
  ...
  const ValueLabel = components.ValueLabel || _ValueLabelUnstyled.default;
  ...
  return /*#__PURE__*/React.createElement(Root, (0, _extends2.default)({
  ...
  }), /*#__PURE__*/React.createElement(Rail, (0, _extends2.default)({}, railProps, {
    className: (0, _clsx.default)(utilityClasses.rail, railProps.className)
  })), /*#__PURE__*/React.createElement(Track, (0, _extends2.default)({}, trackProps, {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, {
      ...
      className: (0, _clsx.default)(utilityClasses.mark, markProps.className, markActive && getUtilityClass('markActive'))
      ...
      className: (0, _clsx.default)(utilityClasses.markLabel, markLabelProps.className, markActive && getUtilityClass('markLabelActive'))
    }), mark.label) : null);
  }), values.map((value, index) => {
    const percent = valueToPercent(value, min, max);
    const style = axisProps[axis].offset(percent);
    return /*#__PURE__*/React.createElement(ValueLabel, (0, _extends2.default)({
      key: index,
      ...
      className: (0, _clsx.default)(utilityClasses.thumb, thumbProps.className, active === index && 'Mui-active', disabled && 'Mui-disabled', focusVisible === index && 'Mui-focusVisible'),
