...
function DescendantProvider(props) {
  ...
  const registerDescendant = React.useCallback((_ref) => {
    let {
      element
        ...
        rest = (0, _objectWithoutPropertiesLoose2.default)(_ref, ["element"]);
    set(oldItems => {
      let newItems;
      ...
      if (oldItems[index] && oldItems[index].element === element) {
        ...
        const newItem = (0, _extends2.default)({}, rest, {
          element,
          index
  ...
  return /*#__PURE__*/React.createElement(DescendantContext.Provider, {
    value: value
  }, children);
}
