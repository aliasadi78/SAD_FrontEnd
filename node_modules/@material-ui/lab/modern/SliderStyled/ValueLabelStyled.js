...
const overridesResolver = (_, styles) => {
  ...
  const styleOverrides = _extends({}, styles.root, {
...
const ValueLabelRoot = experimentalStyled('span', {}, {
...
const ValueLabel = /*#__PURE__*/React.forwardRef(function ValueLabel(inputProps, ref) {
