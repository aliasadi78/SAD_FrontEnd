...
import { useIsFocusVisible, unstable_useEnhancedEffect as useEnhancedEffect, ownerDocument, useEventCallback, useForkRef, capitalize, useControlled } from '@material-ui/core/utils';
...
var getUtilityClass = function getUtilityClass(name) {
...
var useSliderClasses = function useSliderClasses(props) {
  var color = props.color,
      ...
      track = props.track;
  var utilityClasses = {
    root: clsx(getUtilityClass('root'), getUtilityClass("color".concat(capitalize(color))), disabled && 'Mui-disabled', marked && getUtilityClass('marked'), track === false && getUtilityClass('trackFalse'), orientation === 'vertical' && getUtilityClass('vertical'), track === 'inverted' && getUtilityClass('trackInverted')),
    ...
    thumb: clsx(getUtilityClass('thumb'), getUtilityClass("thumbColor".concat(capitalize(color))), disabled && 'Mui-disabled')
  };
  return utilityClasses;
};

var isComponent = function isComponent(element) {
