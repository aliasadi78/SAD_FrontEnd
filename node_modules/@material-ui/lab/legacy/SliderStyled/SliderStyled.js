...
var overridesResolver = function overridesResolver(props, styles, name) {
  var _extends2;
  ...
  var styleOverrides = _extends({}, styles.root, styles["color".concat(capitalize(color))], {
    '&.Mui-disabled': styles.disabled
  }, marked && styles.marked, orientation === 'vertical' && styles.vertical, track === 'inverted' && styles.trackInverted, track === false && styles.trackFalse, (_extends2 = {}, _defineProperty(_extends2, "& .".concat(name, "-rail"), styles.rail), _defineProperty(_extends2, "& .".concat(name, "-track"), styles.track), _defineProperty(_extends2, "& .".concat(name, "-mark"), styles.mark), _defineProperty(_extends2, "& .".concat(name, "-markLabel"), styles.markLabel), _defineProperty(_extends2, "& .".concat(name, "-valueLabel"), styles.valueLabel), _defineProperty(_extends2, "& .".concat(name, "-thumb"), _extends({}, styles.thumb, styles["thumbColor".concat(capitalize(color))], {
    '&.Mui-disabled': styles.disabled
  })), _extends2));
...
var SliderRoot = experimentalStyled('span', {}, {
  muiName: 'MuiSlider',
  ...
  return _extends({
    ...
    '& .MuiSlider-markLabel': _extends({}, props.theme.typography.body2, {
